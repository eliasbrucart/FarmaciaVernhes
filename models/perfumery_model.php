...
class PerfumeryModel{
    static public function UploadPerfumery($table, $data){
        $stmt = Connection::Connect()->prepare("INSERT INTO $table(name_perfumery, file_perfumery, order_perfumery, date_perfumery) VALUES(:name_perfumery, :file_perfumery, :order_perfumery, :date_perfumery)");
